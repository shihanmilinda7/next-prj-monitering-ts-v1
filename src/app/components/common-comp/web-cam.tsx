    ...
    <div>
      ...
      <div>
        ...
        >
          ...
          <button
            ...
            className="mt-3 w-full rounded-lg bg-gradient-to-r from-purple-500 to-purple-600  hover:bg-gradient-to-l hover:from-purple-500 hover:to-purple-600 py-3 px-8 text-center text-base font-semibold text-white outline-none"
          >
            Capture
          </button>
        </div>
      ...
      <div className="flex">
        {capturedImage && !cameraActive && (
          <div
            className={
              !cameraActive ? "w-full flex ml-auto" : "flex ml-auto hidden"
            }
          >
            <button
              onClick={uploadImg}
