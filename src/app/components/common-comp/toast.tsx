...
type closeButton = (e: React.MouseEvent<HTMLButtonElement>) => void;
type Props = {
    title: string
    description: string
...
const Toast = ({ title, closeButtonAction, description, buttonColour }:Props) => {

    const bgColour = buttonColour ||"bg-gray-800 dark:bg-gray-900"

    return (
        <div className="absolute bottom-10 right-10">
            <div className={"max-w-xl text-xl text-white rounded-md shadow-lg mb-3 ml-3 ml-3 " + bgColour} role="alert">
