...
const CategoryInputField = ({
  ...
  return (
    <div className="flex mb-5">
      ...
      <div
        className={
          deleteCategoryInputField ? "flex ml-auto" : "flex ml-auto hidden"
        }
      >
        <button
          type="button"
          onClick={(e) => deleteInputField(e, index)}
          className="bg-red-600 rounded-md p-2 inline-flex items-center justify-center text-red-100 hover:text-red-600 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-500"
        >
